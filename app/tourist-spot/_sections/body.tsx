    ...
    <div className="flex flex-col w-full overflow-auto">
      ...
      <div className="flex flex-col w-full h-full overflow-hidden bg-black">
        <div className="items-center gap-10 p-10 font-bold w-full h-full flex flex-col">
          ...
          <motion.div
            className="flex flex-col md:flex-row text-white justify-evenly gap-10  items-center w-full "
          ...
          >
            ...
            <div className="w-full h-full items-center md:mr-24 flex ">
              <p className="w-full text-white  h-full flex ">
          ...
          <motion.div
            className="flex flex-col md:flex-row text-white justify-center gap-10 items-center w-full "
            initial={{ opacity: 0, x: 100 }}
            animate={{ opacity: 1, x: -0 }}
